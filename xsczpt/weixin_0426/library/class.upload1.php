...
class upload {
    ...
    function init() {
        ...
        $this->image_x                  = 150;
        $this->image_y                  = 150;
		$this->image_src_x_val			= 0;
		$this->image_src_y_val			= 0;
		$this->image_src_w_val			= 0;
		$this->image_src_h_val			= 0;
        ...
        if (!is_array($file)) {
            if (empty($file)) {
                ...
                echo $file;
                    ...
                    echo $this->file_src_pathname;exit;
            ...
            if ($image_manipulation) {
                ...
                if ($this->processed && $image_src) {
                    ...
                    if ($this->image_resize) {
                        ...
                        $w = !$this->image_src_w_val?$this->image_src_x:$this->image_src_w_val;
						$h = !$this->image_src_h_val?$this->image_src_y:$this->image_src_h_val;
                        if ($gd_version >= 2 && !$this->preserve_transparency) {
                           $res = imagecopyresampled($image_dst, $image_src, 0, 0, $this->image_src_x_val, $this->image_src_y_val, $this->image_dst_x, $this->image_dst_y, $w, $h);
                        } else {
                            $res = imagecopyresized($image_dst, $image_src, 0, 0, $this->image_src_x_val, $this->image_src_y_val, $this->image_dst_x, $this->image_dst_y, $w, $h);
                        }
