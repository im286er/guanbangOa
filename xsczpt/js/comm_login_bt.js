      ...
      try {
          ...
          if (o.ret == "no") {
			  if(window.atob){
				 ...
				 var url=window.Base64.encode(document.URL);  
			  }
              		  
              $("#top_user_login").html('<li><a href="/?t=login&url='+url+'" style="display:none;">登录</a></li><li><a href="/?t=reg" style="display:none;">注册</a></li>');
          }
          else {            
            switch(o.idtype){
              case '1':s='stu';break;
