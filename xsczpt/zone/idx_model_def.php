...
switch($qname){
    ...
    case "index":                                                                                            
		...
		$T->SetBlock("blogt_list","select * from blog_list order by created limit 10");
		$T->SetBlock("board_list","select * from `zone_leave` order by timestamp limit 10");
        $T->SetBlock("ind_photo","select * from zone_album where uid='".$zid."' order by lastupdate limit 3"); 
    ...
    case "photo":                                            
        ...
        $page=getPageHtml_bt($rc,20,$p,"&t=photo&aid=".$aid."&id=".$zid);
        $T->Set("page",$page); 
