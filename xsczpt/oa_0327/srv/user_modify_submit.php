<?php
	...
	if($submitMethod=='POST'){
		...
		if($flag==2){
			...
			//$relation   = Filter::filter_html($_POST['relation']);
			$data = array(
				'gender'           => $gender,
				'qq' 		 	   => $qq,
				'used_name'  	   => $usedName,
		...
		$params2      = array('data'=>$data2,'table'=>'oa_zhsz_relative','where'=>"user_id='{$_SESSION['uid']}' and relation='母亲'");
		$result2     = $pd->update($params2);   
